	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'hero-gradient-2': 'var(--gradient-accent)',
				'pulse-gradient': 'var(--gradient-secondary)',
				'brand-logos': 'repeating-conic-gradient(from 0deg at 50% 50%, transparent 0deg, rgba(255,255,255,0.03) 60deg, transparent 120deg)',
			},
			fontFamily: {
